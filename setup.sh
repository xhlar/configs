...
udo apt-get -y install spotify-client
...
wget https://raw.githubusercontent.com/xhlar/dotfiles/master/.bashrc
wget https://raw.githubusercontent.com/xhlar/dotfiles/master/.zshrc
wget https://raw.githubusercontent.com/xhlar/dotfiles/master/.vimrc
